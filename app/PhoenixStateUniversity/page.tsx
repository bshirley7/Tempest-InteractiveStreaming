...
import { Play, Calendar, Eye, TrendingUp, Image as ImageIcon, Users, GraduationCap } from 'lucide-react';
...
const COMPANY_INFO = {
  name: 'Phoenix State University',
  tagline: 'Rise Higher, Soar Further',
  description: '183,000 students, Arizona-based, modern campus. Channels include Campus News, Academic Lectures, Alumni Network, Career Services, Student Life, and Sun Devils Sports.',
  logoPath: '/company-logos/pheonix-state-university-logo.svg',
  brandColor: '#DC2626',
  accentColor: '#DC262620'
};
...
const SAMPLE_IMAGE_ADS: ImageAd[] = [
  ...
  {
    id: '2',
    title: 'PSU Sun Devils Sports',
    description: 'Cheer on the Sun Devils this season!',
  ...
  {
    id: '3',
    title: 'PSU Career Services',
    description: 'From internships to dream jobs - we help you succeed',
  ...
  {
    id: '4',
    title: 'PSU Campus Life',
    description: 'Experience the vibrant student life at Phoenix State',
...
export default function PhoenixStateUniversityCampaignPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-8">
            <div className="w-32 h-32 bg-gray-700 rounded-2xl flex items-center justify-center p-4 border border-gray-600">
              ...
              />
              <div 
                className="w-full h-full bg-gray-600 rounded-xl flex items-center justify-center text-white font-bold text-2xl"
                style={{ display: 'none' }}
              >
                PSU
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="bg-gray-700 border-gray-600">
              <CardContent className="p-6">
                <div className="flex items-center gap-3">
                  <Users className="w-8 h-8" style={{ color: COMPANY_INFO.brandColor }} />
                  <div>
                    <div className="text-2xl font-bold text-white">183K</div>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300 text-sm">Campaigns</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-700 border-gray-600">
              <CardContent className="p-6">
                <div className="flex items-center gap-3">
                  <GraduationCap className="w-8 h-8" style={{ color: COMPANY_INFO.brandColor }} />
                  <div>
                    <div className="text-2xl font-bold text-white">Arizona</div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-4">University Marketing Campaigns</h2>
