-- Run this SQL in your Supabase SQL Editor to create the interaction_responses table

-- Create interaction_responses table for storing user responses to polls, quizzes, etc.
